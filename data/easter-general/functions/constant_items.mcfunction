...
execute as @a[team=gatherers] store result score @s has_pick run clear @s diamond_pickaxe 0
execute as @a[team=gatherers] if score @s has_pick matches 0 run give @s diamond_pickaxe{Unbreakable:true, CanDestroy:[terracotta, white_terracotta, orange_terracotta, magenta_terracotta, light_blue_terracotta, yellow_terracotta, lime_terracotta, pink_terracotta, gray_terracotta, light_gray_terracotta, cyan_terracotta, purple_terracotta, blue_terracotta, brown_terracotta, green_terracotta, red_terracotta, black_terracotta, white_concrete, orange_concrete, magenta_concrete, light_blue_concrete, yellow_concrete, lime_concrete, pink_concrete, gray_concrete, light_gray_concrete, cyan_concrete, purple_concrete, blue_concrete, brown_concrete, green_concrete, red_concrete, black_concrete], HideFlags:8} 1
execute as @a[team=gatherers] if score @s has_pick matches 2.. run clear @s diamond_pickaxe 1
execute as @a[team=gatherers] run clear @s iron_pickaxe 1

execute as @a[team=hunters] store result score @s has_pick run clear @s iron_pickaxe 0
execute as @a[team=hunters] if score @s has_pick matches 0 run give @s iron_pickaxe{Unbreakable:true, CanDestroy:[terracotta, white_terracotta, orange_terracotta, magenta_terracotta, light_blue_terracotta, yellow_terracotta, lime_terracotta, pink_terracotta, gray_terracotta, light_gray_terracotta, cyan_terracotta, purple_terracotta, blue_terracotta, brown_terracotta, green_terracotta, red_terracotta, black_terracotta], HideFlags:8} 1
