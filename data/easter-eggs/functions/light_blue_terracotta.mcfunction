# This function defines the rewards for finding a light_blue_terracotta block

# Do not modify these commands
scoreboard players remove @s light_blue_terracotta_broken 1
...
function easter-general:ocean_reward
