# This function defines the rewards for finding a light_gray_terracotta block

# Do not modify these commands
scoreboard players remove @s light_gray_terracotta_broken 1
...
function easter-eggs:base_reward
