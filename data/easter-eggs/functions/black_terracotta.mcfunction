# This function defines the rewards for finding a black_terracotta block

# Do not modify these commands
scoreboard players remove @s black_terracotta_broken 1
...
function easter-general:nether_reward
